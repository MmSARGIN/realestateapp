...
const Properties = (props) => {
    ...
    return <div className="flex flex-col items-center justify-center w-full h-auto">
        <div className="flex justify-start items-center w-full  h-full mt-24 overflow-auto">
                ...
                <div className="flex  flex-col w-full justify-start items-center h-full">
                    {product ? product.map((i) => (
                        ...
                        <div key={i.Id} className="flex p-2 w-full justify-center items-center">
                            <div key={i.Id} className="flex border flex-col w-full md:flex-row  md:max-w-6xl rounded-lg bg-white shadow-lg">
                                ...
                                <div className="p-2  h-full text-sky-400 w-full flex flex-col items-center justify-between ">
                                    ...
                                    <div className="flex text-xs sm:text-base p-4 flex-col w-full h-3/4 items-center justify-evenly">
