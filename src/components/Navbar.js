...
const Navbar = () => {
    return <div className=" flex items-center fixed z-10 w-full  bg-white justify-between h-b">
        ...
        <div className="flex w-full  justify-around items-center h-12">
            ...
            <div className="flex w-4/12 justify-end items-center h-3/4">
                <Link className="flex justify-around items-center w-2/4 h-full hover:bg-sky-400 bg-sky-500 rounded-full" to='/login'>
                    ...
                    <div className="flex justify-around items-center w-full h-full ">
                        ...
                        <div className="flex justify-evenly items-center w-4/12 h-full rounded-full  ">
                            <h1 className="text-white">Login</h1>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="WHITE" class="w-6 h-6">
                                <path strokLinecap="round" strokeLinejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0013.5 3h-6a2.25 2.25 0 00-2.25 2.25v13.5A2.25 2.25 0 007.5 21h6a2.25 2.25 0 002.25-2.25V15m3 0l3-3m0 0l-3-3m3 3H9" />
                            </svg>
                        </div>
                    </div>
                </Link>
